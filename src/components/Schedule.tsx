...
const schedule = [
  ...
  },
  {
    day: 'Day 2',
    date: 'May 2, 2025',
    theme: 'Competitions Begin',
    events: [
      { time: '09:00 AM', title: 'Code Hunt — Round 1', location: 'Lab Block', type: 'competition' },
      { time: '11:00 AM', title: 'Robotics Challenge Begins', location: 'Workshop Hall', type: 'competition' },
      { time: '01:00 PM', title: 'Lunch Break', location: 'Cafeteria', type: 'break' },
      { time: '02:00 PM', title: 'Hackathon Kickoff', location: 'Hall B', type: 'competition' },
      { time: '04:00 PM', title: 'Workshop: AI & Machine Learning', location: 'Seminar Hall', type: 'workshop' },
      { time: '06:00 PM', title: 'Cultural Evening', location: 'Open Air Stage', type: 'ceremony' },
    ],
  },
  {
    day: 'Day 3',
    date: 'May 3, 2025',
    theme: 'Deep Dive & Finals',
    events: [
      { time: '09:00 AM', title: 'Code Hunt — Final Round', location: 'Lab Block', type: 'competition' },
      { time: '10:00 AM', title: 'Tech Quiz Battle — Finals', location: 'Hall A', type: 'competition' },
      { time: '12:00 PM', title: 'Lunch Break', location: 'Cafeteria', type: 'break' },
      { time: '01:00 PM', title: 'Hackathon Continues (24hr)', location: 'Hall B', type: 'competition' },
      { time: '03:00 PM', title: 'Robotics Challenge — Finals', location: 'Workshop Hall', type: 'competition' },
      { time: '05:00 PM', title: 'Guest Talk: Industry Experts', location: 'Auditorium', type: 'workshop' },
    ],
  },
  {
    day: 'Day 4',
    date: 'May 4, 2025',
    theme: 'Grand Finale & Closing',
    events: [
      { time: '09:00 AM', title: 'Hackathon Submission & Presentations', location: 'Hall B', type: 'competition' },
      { time: '11:00 AM', title: 'Project Exhibitions', location: 'Exhibition Hall', type: 'general' },
      { time: '01:00 PM', title: 'Lunch Break', location: 'Cafeteria', type: 'break' },
      { time: '02:30 PM', title: 'Results Announcement', location: 'Auditorium', type: 'ceremony' },
      { time: '04:00 PM', title: 'Prize Distribution Ceremony', location: 'Auditorium', type: 'ceremony' },
      { time: '05:30 PM', title: 'Closing Ceremony & Farewell', location: 'Open Grounds', type: 'ceremony' },
    ],
  },
];
