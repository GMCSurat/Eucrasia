      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Experience the most thrilling cultural event of the year. Defining ecstasy and defying misery.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-gray-400 hover:text-red-500 transition-colors">
                <Phone size={20} />
                <span>+91 9537332178</span>
              </div>
              <div className="flex items-center gap-3 text-gray-400 hover:text-red-500 transition-colors">
                <MapPin size={20} />
                <span>Government Medical College, Surat, Majura Gate, 395001</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://instagram.com/eucrasia_2026"
                target="_blank"
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400">
            © EUCRASIA 2026. All rights reserved. | Designed with passion
          </p>
        </div>
      </div>
    </footer>
